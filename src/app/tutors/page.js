      ...
      <div className="max-w-7xl mx-auto mb-10 px-2">
        <div className="flex flex-col sm:flex-row gap-3 items-center w-full">
          ...
          <div className="relative flex-1 w-full">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 dark:text-gray-400">
          ...
          <div className="flex gap-3 w-full sm:w-auto justify-end items-center">
            ...
            <button
              ...
              className="px-5 py-3 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 font-bold text-sm rounded-2xl transition shadow-sm border border-transparent dark:border-gray-700 cursor-pointer"
            >
              Clear
            </button>
          </div>
